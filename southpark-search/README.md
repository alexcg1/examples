...
Just like the `doc_indexer`, the `chunk_indexer` behaves differently based on different requests. For the `IndexRequest`, the `chunk_indexer` uses three Drivers in serial:
